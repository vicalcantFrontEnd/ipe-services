...
export function buildLeccionPrompt(input: LeccionRequest): string {
  ...
  return [
    ...
    '- `secciones`: al menos 3 secciones, cada una con sustancia clínica aplicable (mecanismo, aplicación, indicaciones/contraindicaciones, errores frecuentes y su manejo). Evita repetir contenido entre secciones.',
